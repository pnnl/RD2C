...
if __name__ == "__main__":
    ...
    parser.add_argument('--skew', '-s', default=0.5, type=float, help='skew factor')
    ...
    parser.add_argument('--multi_model', default=0, type=int, help='workers use different Models during training')
    ...
    parser.add_argument('--large_model', default=0, type=int, help='use larger model')
